...
import { Info, Calendar, Edit2 } from 'lucide-react';
import { SOASummary } from '../types/evaluator';
...
export const SOACard = ({ soa, totalRelevantCount, dueDate, onEditDueDate }: SOACardProps) => {
  return (
